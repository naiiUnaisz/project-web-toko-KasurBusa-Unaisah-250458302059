...
<body class="bg-gray-50">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                ...
                <div class="flex items-center space-x-4">
                    <!-- Wishlist  -->
                    <a href="wishlist.html" class="text-gray-900 hover:text-primary-custom relative">
   ...
   <footer class="bg-[#1B1717] text-white py-12">
    ...
    <a href="https://wa.me/62812xxxx?text=Halo%2C%20saya%20ingin%20bertanya%20tentang%20produk%20kasur%20Anda." target="_blank" 
